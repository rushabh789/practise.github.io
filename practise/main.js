...
module.exports = "<div class=\"blog-post\">\n  <h2 class=\"blog-post-title\">{{ post.id }}-{{ post.title }}</h2>\n  <p>{{ post.body }}</p>\n  <hr>\n</div>\n"
...
module.exports = __webpack_require__(/*! /home/rushabh/Development/practise/src/main.ts */"./src/main.ts");
